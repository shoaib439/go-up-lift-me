            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_causes">
                        <h4>Give Donation</h4>
                        <img src="{{ asset('public/img/causes/c1.png') }}"  >
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_causes">
                        ...
                        <img src="{{ asset('public/img/causes/c2.png') }}"  >
                        <p>
                            It you're. Was called you're fowl grass lesser land together waters beast darkness earth land whose male all moveth fruitful.
                        </p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_causes">
                        ...
                        <img src="{{ asset('public/img/causes/c3.png') }}"  >
                        <p>
                            It you're. Was called you're fowl grass lesser land together waters beast darkness earth land whose male all moveth fruitful.
                        </p>
                    </div>
                ...
                <div class="single_about row">
                    <div class="col-lg-6 col-md-12 text-center about_left">
                        <div class="about_thumb">
                            ...
                            <img src="{{ asset('public/img/about-img.jpg') }}"  class="img-fluid" alt="" >
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="{{ asset('public/img/features/fc1.jpg') }}" class="img-fluid" alt="Card image cap">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="{{ asset('public/img/features/fc2.jpg') }}" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <figure>
                                <img class="card-img-top img-fluid" src="{{ asset('public/img/features/fc3.jpg') }}" alt="Card image cap">
                            </figure>
                            <div class="card_inner_body">
                    ...
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="{{ asset('public/img/event/e1.jpg') }}" alt="">
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="{{ asset('public/img/event/e2.jpg') }}" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="{{ asset('public/img/event/e3.jpg') }}" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-6">
                    <div class="single_event">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <figure>
                                    <img class="img-fluid w-100" src="{{ asset('public/img/event/e4.jpg') }}" alt="">
                                    <div class="img-overlay"></div>
                                </figure>
                            </div>
                            <div class="col-lg-6 col-md-6">
        ...
        <div class="container">
            ...
            <div class="row team_inner">
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="{{ asset('public/img/volunteer/v1.jpg') }}" alt="">
                        </div>
                        <div class="team_name">
                            <h4>Alea Mirslava</h4>
                            <p>Party Manager</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="{{ asset('public/img/volunteer/v2.jpg') }}" alt="">
                        </div>
                        <div class="team_name">
                            <h4>Adam Virland</h4>
                            <p>Party Manager</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="{{ asset('public/img/volunteer/v3.jpg') }}" alt="">
                        </div>
                        <div class="team_name">
                            <h4>Adam Virland</h4>
                            <p>Party Manager</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid" src="{{ asset('public/img/volunteer/v4.jpg') }}" alt="">
                        </div>
                        <div class="team_name">
                            <h4>Adam Virland</h4>
                            <p>Party Manager</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-story">
                        <div class="story-thumb">
                            <img class="img-fluid" src="{{ asset('public/img/story/s1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-story">
                        <div class="story-thumb">
                            <img class="img-fluid" src="{{ asset('public/img/story/s2.jpg') }}" alt="">
                        </div>
                        <div class="story-details">
                            <div class="story-meta">
                                <a href="#">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-story">
                        <div class="story-thumb">
                            <img class="img-fluid" src="{{ asset('public/img/story/s3.jpg') }}" alt="">
                        </div>
                        <div class="story-details">
                            <div class="story-meta">
                                <a href="#">
